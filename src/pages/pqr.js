...
const Inicio = () => {
  ...
  return (
    <div className='pqr-page'>
        ...
        <div className='mensaje-pqr'>
          <h1>Tu solicitud es nuestra prioridad.</h1>
          <p>En Enfoque Constructores queremos que tu experiencia 
            sea excelente en cada etapa del proceso. Si tienes alguna
             petición, queja o reclamo, <strong>estamos aquí para escucharte y 
             brindarte una solución en el menor tiempo posible.</strong></p>
          <h2>Déjanos tus datos y detalle de tu solicitud, 
            <span style={{ color: '#e99e3c'}} > estamos aquí para resolverlo pronto.</span></h2>
