...
const Inicio = () => {
  ...
  return (
    <div className='vivienda-page'>
      <div className='vivienda-page-title'>
        <img id="elementoV1" src={Vivienda} alt="Constructor" />
        <h2 id="elementoV2">Si <strong>buscas vivienda</strong></h2>

      </div>
      <div className='vivienda-form'>
        <div className='mensaje-vivienda'>
          <p>Para invertir o vivir, te conectamos con proyectos confiables y bien gestionados, 
            brindándote acompañamiento en cada paso hasta la entrega de tu nuevo hogar.
            Si buscas vivienda, te acompañamos en todo el proceso para que tu compra sea fácil
             y segura. Si quieres invertir, te conectamos con proyectos inmobiliarios de alta rentabilidad.</p>
             <h2>Déjanos tus datos y descubre las mejores opciones para ti.</h2>
        </div>
